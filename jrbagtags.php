...
<html>
    ...
    <body id="home">
        <div class="container"> <!-- container -->   
            ...
            <div class="row">
                <div class="col-sm-4">
                    <a href="products.php?cPath=115"><img class="img-responsive" src="images/awards/awards page shield b jr bag tags.jpg" alt="awards page shield b jr bag tags"></a>
                </div>
                <div class="col-sm-4">
                    <a href="products.php?cPath=116"><img class="img-responsive" src="images/awards/awards page shield a jr bag tags.jpg" alt="awards page shield a jr bag tags"></a>
                </div>
            </div>             
