...
if (isset($_POST['submitted'])):
    ...
    foreach ($ybaCart as $key => $val) {
        $quantity = setcookie("ybaCart[" . ($key) . "][customers_basket_quantity]", $quantity, time() + (86400 * 30), "/");
...
if (isset($_POST['delete'])):
    ...
    foreach ($ybaCart as $key => $val) {
        setcookie("ybaCart[" . ($key) . "][products_id]", "", time() + (86400 * 30), "/");
        setcookie("ybaCart[" . ($key) . "][customers_basket_quantity]", "", time() + (86400 * 30), "/");
        setcookie("ybaCart[" . ($key) . "][title]", "", time() + (86400 * 30), "/");
        setcookie("ybaCart[" . ($key) . "][background]", "", time() + (86400 * 30), "/");
        setcookie("ybaCart[" . ($key) . "][customs]", "", time() + (86400 * 30), "/");
        setcookie("ybaCart[" . ($key) . "][footer]", "", time() + (86400 * 30), "/");
        setcookie("ybaCart[" . ($key) . "][upload]", "", time() + (86400 * 30), "/");
